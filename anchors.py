...
class AnchorGenerator(object):
    ...
    def __init__(self,
                 size: float,
                 aspect_ratios: typing.Sequence[float],
                 stride: int = 1):
        """
    ...
    def tile_anchors_over_feature_map(self, feature_map_shape):
        ...
        Parameters
        ----------
        feature_map: typing.Tuple[int, int, int] H, W , C
...
def anchor_targets_bbox(anchors: tf.Tensor,
    ...
    labels_per_anchor = tf.one_hot(labels_per_anchor, axis=-1, depth=num_classes)
...
def compute_gt_annotations(anchors: tf.Tensor,
                           ...
                           positive_overlap=0.5) -> typing.Tuple[tf.Tensor,
                                                          tf.Tensor,
                                                          tf.Tensor]:
    """
    ...
    Returns
    -------
    typing.Tuple[tf.Tensor, tf.Tensor, np.ndarray]
