...
def unwrap(image, replace):
    ...
    alpha_index = tf.equal(alpha_channel, 0)
    alpha_index = tf.reshape(alpha_index, (-1, 1))
...
def level_div_256(level):
    return level_div_mult(level, 256)
def level_div_110(level):
    return level_div_mult(level, 110)
...
def level_to_arg(hparams):
    ...
    return {
        ...
        'Posterize': level_div_4,
        'Solarize': level_div_256,
        'SolarizeAdd': level_div_110,
        ...
        'TranslateX': translate_f,
        'TranslateY': translate_f,
